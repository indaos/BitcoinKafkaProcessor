...
public class ScriptParser {
    ...
    public static boolean isToAddress(List<Element> elements) {
        if ( elements.size() == 5){
            if (elements.get(0).opcode==OP_DUP && elements.get(1).opcode==OP_HASH160 &&
